...
jQuery(function() {
  $.cylinder = function(element, options) {
    ...
    this.init = function() {
      ...
      this.paper.setViewBox(0, 0, 110, 235, true);
      this.paper.rect(0, 21, 110, 193).attr(this.settings.colors.container);
      this.paper.ellipse(55, 213, 55, 21).attr(this.settings.colors.container);
      this.paper.ellipse(55, 23, 55, 21).attr(this.settings.colors.container);
      this.fluid = this.paper.rect(0, 193, 110, 0).attr(this.settings.colors.fluid);
      this.paper.ellipse(55, 213, 55, 21).attr(this.settings.colors.fluid);
      this.fluidTop = this.paper.ellipse(55, 213, 55, 21).attr(this.settings.colors.accent);
      this.glow = this.paper.path('M 12 35.665 L 12 211 C 12 211.5 17.125 214.375 23.125 216.25 C 28.294 217.8653 36.875 219.25 37 219 L 37 42.75 C 28.4056 41.56 19.8109 39.536 12 35.665 L 12 35.665 Z');
